...
- （2026-09-24追加）2段階目で`activity`（昼行性・夜行性）をMarkdownに追加した後、トップページの大きな写真（ヒーローのスライドショー）から昼行性の種を除外する。ただし、昼行性でもナイトツアーで見られる例外の種（ルリカケス・アカハラダカ・リュウキュウアサギマダラなど、`threads/overrides.yml`で昼行性の印を付けていない種）は表示する
